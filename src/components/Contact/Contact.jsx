...
const Contact = () => {
  ...
  const location = "Adyar Shakthi Trader, No.2 MTH Road, Pattabiram, Chennai 600072";
  const lat = 13.0901;
  const lng = 80.1898;

  // Google Maps URL
  const googleMapsUrl = `https://www.google.com/maps?q=${lat},${lng}&hl=en`;
          ...
          <div className="w-full lg:w-1/2">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center bg-gray-90 p-1 rounded-lg shadow-md border border-gray-300 space-y-1">
                <FontAwesomeIcon icon={faMapMarkerAlt} className="text-2xl" style={{ color: iconColor }} />
                <div className="ml-4">
              ...
              {/* Timing */}
              <div className="flex items-center bg-gray-90 p-1 rounded-lg shadow-md border border-gray-300 space-y-1">
                <FontAwesomeIcon icon={faClock} className="text-2xl" style={{ color: iconColor }} />
                <div className="ml-4">
                  <h3 className="text-2xl font-semibold" style={{ color: iconColor }}>
                    Timing
                  </h3>
                  <span className="text-base-grey font-normal">Mon - Fri: 9:00 AM - 6:00 PM</span>
                </div>
              </div>
              
              {/* Email */}
              <div className="flex items-center bg-gray-90 p-1 rounded-lg shadow-md border border-gray-300 space-y-1">
                <FontAwesomeIcon icon={faEnvelope} className="text-2xl" style={{ color: iconColor }} />
                <div className="ml-4">
                  <h3 className="text-2xl font-semibold" style={{ color: iconColor }}>
                    Email
                  </h3>
              ...
              {/* Phone Number */}
              <div className="flex items-center bg-gray-90 p-1 rounded-lg shadow-md border border-gray-300 space-y-1">
                <FontAwesomeIcon icon={faPhoneAlt} className="text-2xl" style={{ color: iconColor }} />
                <div className="ml-4">
                  <h3 className="text-2xl font-semibold" style={{ color: iconColor }}>
                    Phone No.
                  </h3>
              ...
              {/* Live Chat */}
              <div className="flex items-center bg-gray-90 p-1 rounded-lg shadow-md border border-gray-300 space-y-1">
                <FontAwesomeIcon icon={faComments} className="text-2xl" style={{ color: iconColor }} />
                <div className="ml-4">
                  <h3 className="text-2xl font-semibold" style={{ color: iconColor }}>
                    Live Chat
                  </h3>
